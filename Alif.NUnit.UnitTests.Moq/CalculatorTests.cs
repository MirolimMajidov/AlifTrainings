...
namespace UnitTesting.NUnit
{
    ...
    public class CalculatorTests
    {
        ...
        public void CalculatorAdd_FirstValue4AndSecondValue11_ThatShouldBeEqultTo15()
        {
            ...
            //_loggerMock.SetupProperty(p => p.Type, "");
            // _loggerMock.SetupGet(p => p.Type).Returns("File");
            // _loggerMock.SetupGet(p => p.GetType()).Returns("MyFile");
            
            // _calculator.maxNumber = 20;
            var type = _loggerMock.Object.Type;
            // var type2 = _loggerMock.Object.GetType();
